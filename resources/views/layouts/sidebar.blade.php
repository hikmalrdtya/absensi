    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6">
            <ul class="space-y-3">
                ...
                <li>
                    <a href="/absensi" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-blue-700/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-100" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                ...
                <li>
                    <a href="/absensi/petugas" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-blue-700/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-100" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M19 3h-1V1h-2v2H8V1H6v2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM7 10h10v2H7v-2z" />
        ...
        <div class="px-4 py-5 border-t border-blue-500">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <a href="/logout" class="text-blue-100 hover:text-white flex items-center gap-2">
